...
function useInspectorControlsTabs(blockName) {
  ...
  const advancedFills = [...((0, _components.__experimentalUseSlotFills)(_inspectorControls.InspectorAdvancedControls.slotName) || []), ...((0, _components.__experimentalUseSlotFills)(bindingsGroup.Slot.__unstableName) || [])];
  const settingsFills = [...((0, _components.__experimentalUseSlotFills)(defaultGroup.Slot.__unstableName) || []), ...((0, _components.__experimentalUseSlotFills)(positionGroup.Slot.__unstableName) || []), ...(hasListFills && hasStyleFills > 1 ? advancedFills : [])];
