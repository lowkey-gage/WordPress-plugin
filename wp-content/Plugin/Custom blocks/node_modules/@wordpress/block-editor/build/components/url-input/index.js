...
class URLInput extends _element.Component {
  ...
  updateSuggestions(value = '') {
    ...
    request.then(suggestions => {
      ...
      if (!!suggestions.length) {
        this.props.debouncedSpeak((0, _i18n.sprintf)( /* translators: %s: number of results. */
  ...
  renderControl() {
    ...
    const controlProps = {
      ...
      label,
      className: (0, _clsx.default)('block-editor-url-input', className, {
    ...
    const inputProps = {
      ...
      role: 'combobox',
      'aria-label': label ? undefined : (0, _i18n.__)('URL'),
 ...
 */
var _default = exports.default = (0, _compose.compose)(_compose.withSafeTimeout, _components.withSpokenMessages, _compose.withInstanceId, (0, _data.withSelect)((select, props) => {
