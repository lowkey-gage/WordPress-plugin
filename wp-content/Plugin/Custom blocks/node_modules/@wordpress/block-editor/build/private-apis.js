...
var _textAlignmentControl = _interopRequireDefault(require("./components/text-alignment-control"));
...
var _blockPopover = require("./components/block-popover");
var _library = require("./components/inserter/library");
var _publishDateTimePicker = require("./components/publish-date-time-picker");
...
(0, _lockUnlock.lock)(privateApis, {
  ...
  extractWords: _searchItems.extractWords,
  getNormalizedSearchTerms: _searchItems.getNormalizedSearchTerms,
  ...
  TabbedSidebar: _tabbedSidebar.default,
  ...
  PrivateInserterLibrary: _library.PrivateInserterLibrary,
  reusableBlocksSelectKey: _privateKeys.reusableBlocksSelectKey,
  PrivateBlockPopover: _blockPopover.PrivateBlockPopover,
  PrivatePublishDateTimePicker: _publishDateTimePicker.PrivatePublishDateTimePicker,
  useSpacingSizes: _useSpacingSizes.default,
