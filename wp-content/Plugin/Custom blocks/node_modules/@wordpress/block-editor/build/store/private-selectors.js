...
}, (state, rootClientId) => [...(0, _utils.getAllPatternsDependants)(select)(state), ...(0, _utils.getInsertBlockTypeDependants)(state, rootClientId)]));
...
const isResolvingPatterns = exports.isResolvingPatterns = (0, _data.createRegistrySelector)(select => (0, _data.createSelector)(state => {
  const blockPatternsSelect = state.settings[_privateKeys.selectBlockPatternsKey];
