...
exports.blockEditingModes = blockEditingModes;
...
exports.openedBlockSettingsMenu = openedBlockSettingsMenu;
exports.preferences = preferences;
exports.registeredInserterMediaCategories = registeredInserterMediaCategories;
 ...
 */
const blocks = exports.blocks = (0, _compose.pipe)(_data.combineReducers, withSaveReusableBlock,
 ...
 * @return {string} Updated state.
 */
function preferences(state = _defaults.PREFERENCES_DEFAULTS, action) {
  switch (action.type) {
    case 'INSERT_BLOCKS':
    case 'REPLACE_BLOCKS':
      {
        const nextInsertUsage = action.blocks.reduce((prevUsage, block) => {
          ...
          const match = (0, _data.select)(_blocks.store).getActiveBlockVariation(blockName, attributes);
          if (match?.name) {
            id += '/' + match.name;
          }
    ...
    case 'UPDATE_BLOCK_LIST_SETTINGS':
      {
        ...
        for (const clientId in updates) {
          ...
          } else if ((0, _es.default)(state[clientId], updates[clientId])) {
            delete updates[clientId];
          }
        }
