...
import { getBlockType, getSaveContent, isUnmodifiedDefaultBlock, serializeRawBlock, switchToBlockType, getDefaultBlockName, isUnmodifiedBlock, isReusableBlock, getBlockDefaultClassName, hasBlockSupport, store as blocksStore, privateApis as blocksPrivateApis } from '@wordpress/blocks';
...
function BlockListBlock({
  ...
  let blockEdit = /*#__PURE__*/_jsx(BlockEdit, {
    name: name,
  ...
  if (!isValid) {
    ...
    block = /*#__PURE__*/_jsxs(Block, {
      className: "has-warning",
      children: [/*#__PURE__*/_jsx(BlockInvalidWarning, {
        clientId: clientId
      }), /*#__PURE__*/_jsx(RawHTML, {
        children: safeHTML(saveContent)
      })]
    });
  } else if (mode === 'html') {
    // Render blockEdit so the inspector controls don't disappear.
    // See #8969.
    block = /*#__PURE__*/_jsxs(_Fragment, {
      children: [/*#__PURE__*/_jsx("div", {
        ...
        isHtml: true,
        children: /*#__PURE__*/_jsx(BlockHtml, {
          clientId: clientId
        })
      })]
    });
  ...
  const updatedWrapperProps = {
    ...restWrapperProps,
    className: clsx(restWrapperProps.className, dataAlign && themeSupportsLayout && `align${dataAlign}`, !(dataAlign && isSticky) && className)
  };
  ...
  return /*#__PURE__*/_jsx(PrivateBlockContext.Provider, {
    value: {
      wrapperProps: updatedWrapperProps,
      isAligned,
      ...context
    },
    children: /*#__PURE__*/_jsx(BlockCrashBoundary, {
      fallback: /*#__PURE__*/_jsx(Block, {
        className: "has-warning",
        children: /*#__PURE__*/_jsx(BlockCrashWarning, {})
      }),
      children: block
    })
  });
