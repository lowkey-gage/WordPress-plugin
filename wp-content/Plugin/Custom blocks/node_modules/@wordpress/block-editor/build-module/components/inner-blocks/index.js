...
function BlockContext({
  ...
  return /*#__PURE__*/_jsx(BlockContextProvider, {
    value: context,
    children: children
  });
}
...
function UncontrolledInnerBlocks(props) {
  ...
  const items = /*#__PURE__*/_jsx(BlockListItemsMemo, {
  ...
  return /*#__PURE__*/_jsx(BlockContext, {
    clientId: clientId,
    children: items
  });
}
...
function ControlledInnerBlocks(props) {
  useBlockSync(props);
  return /*#__PURE__*/_jsx(UncontrolledInnerBlocks, {
    ...props
  });
}
...
export function useInnerBlocksProps(props = {}, options = {}) {
  ...
  const ref = useMergeRefs([props.ref, __unstableDisableDropZone || isDropZoneDisabled || layout?.isManualPlacement && window.__experimentalEnableGridInteractivity ? null : blockDropZoneRef]);
  ...
  return {
    ...props,
    ref,
    className: clsx(props.className, 'block-editor-block-list__layout', __unstableDisableLayoutClassNames ? '' : layoutClassNames),
    children: clientId ? /*#__PURE__*/_jsx(InnerBlocks, {
      ...innerBlocksProps,
      clientId: clientId
    }) : /*#__PURE__*/_jsx(BlockListItems, {
      ...options
    })
  };
}
