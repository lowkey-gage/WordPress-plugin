...
export function PrivateBlockToolbar({
  ...
  const {
    ...
    return {
      ...
      showParentSelector: parentBlockType && getBlockEditingMode(parentClientId) !== 'disabled' && hasBlockSupport(parentBlockType, '__experimentalParentSelector', true) && selectedBlockClientIds.length === 1,
  ...
  return /*#__PURE__*/_jsx(NavigableToolbar, {
    ...
    children: /*#__PURE__*/_jsxs("div", {
      ...
      children: [!isMultiToolbar && isLargeViewport && /*#__PURE__*/_jsx(BlockParentSelector, {}), (shouldShowVisualToolbar || isMultiToolbar) && !hasParentPattern && /*#__PURE__*/_jsx("div", {
        ref: nodeRef,
        ...
        children: /*#__PURE__*/_jsxs(ToolbarGroup, {
          ...
          }), !isMultiToolbar && isDefaultEditingMode && /*#__PURE__*/_jsx(BlockLockToolbar, {
