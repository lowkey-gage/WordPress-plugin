...
export default function BorderPanel({
  ...
  return /*#__PURE__*/_jsxs(Wrapper, {
    ...
    panelId: panelId,
    label: label,
    children: [(showBorderWidth || showBorderColor) && /*#__PURE__*/_jsx(ToolsPanelItem, {
      hasValue: () => isDefinedBorder(value?.border),
      label: __('Border'),
      onDeselect: () => resetBorder(),
      isShownByDefault: showBorderByDefault,
      panelId: panelId,
      children: /*#__PURE__*/_jsx(BorderBoxControl, {
        colors: colors,
        enableAlpha: true,
    ...
    }), showBorderRadius && /*#__PURE__*/_jsx(ToolsPanelItem, {
    ...
    }), hasShadowControl && /*#__PURE__*/_jsxs(ToolsPanelItem, {
      label: __('Shadow'),
      hasValue: hasShadow,
