 ...
 */
export function getPositionCSS({
  selector,
  style
}) {
  let output = '';
...
export function PositionPanelPure({
  ...
  const stickyHelpText = allowSticky && value === STICKY_OPTION.value && blockInformation ? sprintf( /* translators: %s: the name of the parent block. */
  ...
  return Platform.select({
    web: options.length > 1 ? /*#__PURE__*/_jsx(InspectorControls, {
      group: "position",
