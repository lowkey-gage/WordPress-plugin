 ...
 */
export const getEnabledClientIdsTree = createSelector(getEnabledClientIdsTreeUnmemoized, state => [state.blocks.order, state.blockEditingModes, state.settings.templateLock, state.blockListSettings, state.editorMode, getSectionRootClientId(state)]);
 ...
 *                            to bottom (false).
 */
export const getEnabledBlockParents = createSelector((state, clientId, ascending = false) => {
 ...
 */
export const getStyleOverrides = createSelector(state => {
 ...
 */
export const getInserterMediaCategories = createSelector(state => {
  const {
    settings: {
 ...
 */
export const hasAllowedPatterns = createRegistrySelector(select => createSelector((state, rootClientId = null) => {
  const {
    getAllPatterns
 ...
 */
export const getBlockStyles = createSelector((state, clientIds) => clientIds.reduce((styles, clientId) => {
...
export function getClosestAllowedInsertionPointForPattern(state, pattern, clientId) {
  const {
    allowedBlockTypes
  } = getSettings(state);
