 ...
 *                                         block types.
 */
export const privateRemoveBlocks = (clientIds, selectPrevious = true, forceRemove = false) => ({
  select,
  dispatch,
  registry
}) => {
...
export function stopEditingAsBlocks(clientId) {
  return ({
    ...
    const focusModeToRevert = unlock(registry.select(blockEditorStore)).getTemporarilyEditingFocusModeToRevert();
 ...
 */
export const modifyContentLockBlock = clientId => ({
  select,
  dispatch
}) => {
