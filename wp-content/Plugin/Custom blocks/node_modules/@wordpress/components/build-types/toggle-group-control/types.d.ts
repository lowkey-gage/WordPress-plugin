...
export type ToggleGroupControlOptionIconProps = Pick<ToggleGroupControlOptionBaseProps, 'value'> & {
    /**
...
export type ToggleGroupControlOptionProps = Pick<ToggleGroupControlOptionBaseProps, 'value' | 'showTooltip'> & {
    /**
...
export type ToggleGroupControlProps = Pick<BaseControlProps, 'help' | '__nextHasNoMarginBottom'> & {
    /**
