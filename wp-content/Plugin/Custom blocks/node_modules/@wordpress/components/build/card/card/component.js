...
function UnconnectedCard(props, forwardedRef) {
  ...
  const elevationBorderRadius = isRounded ? _configValues.default.radiusLarge : 0;
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_context.ContextSystemProvider, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsxs)(_view.View, {
      ...otherProps,
      ref: forwardedRef,
      children: [/*#__PURE__*/(0, _jsxRuntime.jsx)(_view.View, {
        className: cx(styles.Content),
        children: children
      }), /*#__PURE__*/(0, _jsxRuntime.jsx)(_elevation.Elevation, {
 ...
 * ```
 */
const Card = exports.Card = (0, _context.contextConnect)(UnconnectedCard, 'Card');
