 ...
 * ```
 */
export function registerBlockCollection(namespace, {
  title,
  icon
}) {
...
export function getBlockSupport(nameOrType, feature, defaultSupports) {
  return select(blocksStore).getBlockSupport(nameOrType, feature, defaultSupports);
}
...
export function hasBlockSupport(nameOrType, feature, defaultSupports) {
  return select(blocksStore).hasBlockSupport(nameOrType, feature, defaultSupports);
}
...
export const registerBlockBindingsSource = source => {
  ...
  const existingSource = unlock(select(blocksStore)).getBlockBindingsSource(name);
