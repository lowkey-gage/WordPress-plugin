...
exports.getBlockBindingsSource = getBlockBindingsSource;
exports.getBlockBindingsSources = getBlockBindingsSources;
...
exports.registerBlockBindingsSource = void 0;
...
exports.registerBlockVariation = void 0;
...
exports.unregisterBlockBindingsSource = unregisterBlockBindingsSource;
...
function registerBlockType(blockNameOrMetadata, settings) {
  ...
  if (typeof name !== 'string') {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block names must be strings.') : void 0;
    return;
  }
  if (!/^[a-z][a-z0-9-]*\/[a-z][a-z0-9-]*$/.test(name)) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block names must contain a namespace prefix, include only lowercase alphanumeric characters or dashes, and start with a letter. Example: my-plugin/my-custom-block') : void 0;
    return;
  }
  if ((0, _data.select)(_store.store).getBlockType(name)) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block "' + name + '" is already registered.') : void 0;
    return;
  }
  const {
    addBootstrappedBlockType,
...
function unregisterBlockType(name) {
  ...
  if (!oldBlock) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block "' + name + '" is not registered.') : void 0;
    return;
  }
...
const registerBlockStyle = (blockNames, styleVariation) => {
  (0, _data.dispatch)(_store.store).addBlockStyles(blockNames, styleVariation);
};
...
const registerBlockVariation = (blockName, variation) => {
  if (typeof variation.name !== 'string') {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Variation names must be unique strings.') : void 0;
  }
...
const registerBlockBindingsSource = source => {
  ...
  const existingSource = (0, _lockUnlock.unlock)((0, _data.select)(_store.store)).getBlockBindingsSource(name);
  ...
  if (existingSource?.getValues) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source "' + name + '" is already registered.') : void 0;
    return;
  }

  // Check the `name` property is correct.
  if (!name) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source must contain a name.') : void 0;
    return;
  }
  if (typeof name !== 'string') {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source name must be a string.') : void 0;
    return;
  }
  if (/[A-Z]+/.test(name)) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source name must not contain uppercase characters.') : void 0;
    return;
  }
  if (!/^[a-z0-9/-]+$/.test(name)) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source name must contain only valid characters: lowercase characters, hyphens, or digits. Example: my-plugin/my-custom-source.') : void 0;
    return;
  }
  if (!/^[a-z0-9-]+\/[a-z0-9-]+$/.test(name)) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source name must contain a namespace and valid characters. Example: my-plugin/my-custom-source.') : void 0;
    return;
  }

  // Check the `label` property is correct.
  if (label && existingSource?.label) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings "' + name + '" source label is already defined in the server.') : void 0;
    return;
  }
  if (!label && !existingSource?.label) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source must contain a label.') : void 0;
    return;
  }
  if (label && typeof label !== 'string') {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source label must be a string.') : void 0;
    return;
  }

  // Check the `usesContext` property is correct.
  if (usesContext && !Array.isArray(usesContext)) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source usesContext must be an array.') : void 0;
    return;
  }

  // Check the `getValues` property is correct.
  if (getValues && typeof getValues !== 'function') {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source getValues must be a function.') : void 0;
    return;
  }

  // Check the `setValues` property is correct.
  if (setValues && typeof setValues !== 'function') {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source setValues must be a function.') : void 0;
    return;
  }

  // Check the `canUserEditValue` property is correct.
  if (canUserEditValue && typeof canUserEditValue !== 'function') {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source canUserEditValue must be a function.') : void 0;
    return;
  }
  ...
  if (getFieldsList && typeof getFieldsList !== 'function') {
    ...
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source getFieldsList must be a function.') : void 0;
    return;
  }
  return (0, _lockUnlock.unlock)((0, _data.dispatch)(_store.store)).addBlockBindingsSource(source);
};
 ...
 * ```
 */
exports.registerBlockBindingsSource = registerBlockBindingsSource;
function unregisterBlockBindingsSource(name) {
  const oldSource = getBlockBindingsSource(name);
  if (!oldSource) {
    globalThis.SCRIPT_DEBUG === true ? (0, _warning.default)('Block bindings source "' + name + '" is not registered.') : void 0;
    return;
  }
  (0, _lockUnlock.unlock)((0, _data.dispatch)(_store.store)).removeBlockBindingsSource(name);
}
...
function getBlockBindingsSource(name) {
  return (0, _lockUnlock.unlock)((0, _data.select)(_store.store)).getBlockBindingsSource(name);
}
...
function getBlockBindingsSources() {
  return (0, _lockUnlock.unlock)((0, _data.select)(_store.store)).getAllBlockBindingsSources();
}
